...
include "../php_utility/user_login_authorize.php";
...
$columns = array(
    ...
    array(
        ...
        'formatter' => function( $d, $row ) {
            switch ($d){
                case '1': $d='Admin';break;
                case '2':  $d='Jim';break;
                case '3':  $d='Amelia';break;
                case '4':  $d='Student';break;
                default: $d='Admin';;
            }
            return $d;
        }
...
if($_SESSION["userid"] != 1)
    $extraCondition = "`{$table}`.`Account`='".$_SESSION["userid"]."'";
else
    $extraCondition="";
